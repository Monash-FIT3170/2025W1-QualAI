...
import { fetchChat, fetchHistory, removeChat } from './chat_client';
    ...
    return (
      ...
      >
        <img
          src={robotIcon}
          alt="AI Assistant"
          className={`w-full h-full object-contain transition-transform duration-300 ${isHoveringClosed ? 'scale-110' : 'scale-100'
            }`}
        />
      </div>
    );
