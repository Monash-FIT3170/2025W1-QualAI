...
#
# A spike for testing the usage of the sentence-transformer framework for chunking and embedding text as vectors, as
...
) -> list[tuple[str, list[Tensor] | ndarray | Tensor]]:
    """
        Generates a vector embedding for each of the provided chunks of text using a sentence transformer model.
            ...
            :return list[tuple[str, list[Tensor] | ndarray | Tensor]]:  a list of tuples containing chunks and their
